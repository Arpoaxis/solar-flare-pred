...
This script loads a saved CNN-GRU checkpoint, collects predicted probabilities
for the validation and test splits, selects the decision threshold that
maximizes the True Skill Statistic (TSS) on the validation set, and then
applies that same threshold to the test set.
